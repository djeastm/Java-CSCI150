...
class TestSList {
	public static void main(String[] args) throws IOException {
		...
		System.out
				.println("  =x  : Replace the element marked by the cursor with x");
		...
		System.out
				.println("  M   : Move element marked by cursor to beginning  "
						+ "(Inactive : In-lab Ex. 1)");
		System.out
				.println("  #x  : Insert x before the cursor                  "
		...
		do {
			...
			while (strTokens.hasMoreTokens()) {
				...
				case '-': // remove
					System.out
							.println("Remove the element marked by the cursor");
					testList.remove();
					break;

				case '=': // replace
					System.out
							.println("Replace the element marked by the cursor "
									+ "with " + testElement);
				...
				case 'n': // gotoNext
					if (testList.gotoNext())
						...
						System.out
								.println("Failed -- either at the end of the list "
				...
				case 'p': // gotoPrior
					if (testList.gotoPrior())
						...
						System.out
								.println("Failed -- either at the beginning of the "
				...
				case 'M':
				case 'm': // In-lab Exercise 1
					System.out
							.println("Move the element marked by the cursor to the "
									+ "beginning of the list");
					testList.moveToBeginning();
					break;

				case '#': // In-lab Exercise 2
					System.out.println("Insert " + testElement + " before the "
							+ "cursor");
